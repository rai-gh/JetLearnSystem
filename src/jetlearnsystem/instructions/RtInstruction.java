...
public class RtInstruction implements JetInstruction {
    private Object angle;

    public RtInstruction(Object angle) {
        this.angle = angle;
    }
    ...
    public void execute(Turtle turtle, TurtleFrame frame, Map<String, Object> variables) throws JetExecutionException {
        ...
        frame.displayInfoMessage("タートルが右へ " + finalAngle + " 度回転します。");
        turtle.rt(finalAngle);
    }
}