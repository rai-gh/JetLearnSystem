...
public class FdInstruction implements JetInstruction {
    private Object distance; 

    public FdInstruction(Object distance) { 
    ...
    public void execute(Turtle turtle, TurtleFrame frame, Map<String, Object> variables) throws JetExecutionException {
        ...
        frame.displayInfoMessage("タートルが前へ " + finalDistance + " 動きます。");
        turtle.fd(finalDistance);
    }
}